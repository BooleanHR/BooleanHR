...
공공기관 및 공기업 채용 프로젝트의 기획(RFP)부터 고사장 세팅, 서류·면접 전형의 차질 없는 운영, 데이터 기반의 사후 분석까지 채용 전반의 실무를 대행하는 PM 유용완입니다.

데이터와 시스템을 기반으로 채용의 전 과정을 투명하게 관리하며, 현장의 비효율을 AI 프로토타이핑과 바이브 코딩(Vibe Coding)을 결합해 혁신하는 데 집중하고 있습니다.

🌐 **[포트폴리오 웹사이트 바로가기](https://booleanhr.github.io/BooleanHR/)**

---

## 🚀 Core Competencies (핵심 전문성)
...
*   프로젝트 진행 중 파악한 신규 니즈를 바탕으로 필기 전형 추가 수의계약 이끌어내어 **단일 계약 규모를 66% 증액(1.2억 → 2.0억)** 시켰습니다.
